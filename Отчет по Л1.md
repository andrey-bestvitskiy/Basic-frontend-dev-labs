...
<p style="text-indent: 25px;">
В ходе организации рабочего пространства был установлен текстовый редактор Visual Studio Code. Также был установлен перечень плагинов:
...
-----
<p style="text-indent: 25px;">
В соответствии с заданием создан репозиторий на сайте github.com с названием “Basic frontend dev labs”. В нем создана ветка lab1, также создана директория “bfdLabs”, которая была успешно подключена к репозиторию на Github.
...
<p style="text-indent: 25px;">
Файл index.html создан и аналогично реализует предыдущее задание. Результат валидации представлен на рисунке 5.
